...
```
El modelo que mejor ajuste presentó fue aquel con laplace = 10 usando la corrección de kernel y ajuste
...
modelo_arbol2 <- train(tipo~., data = data_model_tree, method = "rpart",
                      tuneGrid=grid,
...
```{r tree post poda}
m2 <- rpart(LEAVE~., data = churnTrain,
            control = rpart.control(
